...
public class TieredSpilloverCacheStats implements CacheStats {
    ...
    public TieredSpilloverCacheStats(StatsHolder heapStatsHolder, StatsHolder diskStatsHolder) {
        assert heapStatsHolder.getDimensionNames().equals(diskStatsHolder.getDimensionNames())
            : "Heap stats and disk stats can't have different dimension names";
        this.heapStats = new MultiDimensionCacheStats(heapStatsHolder, TIER_DIMENSION_VALUE_ON_HEAP);
        this.diskStats = new MultiDimensionCacheStats(diskStatsHolder, TIER_DIMENSION_VALUE_DISK);
    }
