...
public class IndicesRequestCacheTests extends OpenSearchSingleNodeTestCase {
    ...
    private TestEntity setupCache(
        ShardRequestCache requestCacheStats,
        IndicesRequestCache cache,
        Directory dir,
    ...
    public void testInvalidateHeapOnly() throws Exception {
        ...
        //setup cache
        TestEntity entity = setupCache(requestCacheStats, cache, dir, reader);
        // clear on-heap cache only
    ...
    public static class CleanDiskCacheTests {
        ...
        public void setup() {
            ...
            indicesRequestCache = new IndicesRequestCache(Settings.EMPTY, indicesService, tieredCacheService);
        }
